...
<form  class="needs-validation" action="act-simpan-datatanaman.php" method="POST" novalidate>
    <fieldset>
    <div class="form-row">
            <label for="id_tanaman" class="col-sm-4 col-form-label offset-sm-2 label1">ID Tanaman: </label>
            <div class="col-sm-4 offset-sm-0">
                <div class="text text1">
            <input type="text"  class="form-control" name="id_tanaman" placeholder="Masukan ID Tanaman" required>
            ...
            <input type="text" class="form-control" name="nama_tanaman" placeholder="Masukan Nama Tanaman" required>
            <div class="invalid-feedback">Pertanyaa ini wajib diisi!</div>
            <div class="valid-feedback">Oke!</div>
            </div>
</div>
</div>
            ...
            <input type="text"  class="form-control" name="jenis_tanaman" placeholder="Masukan Jenis Tanaman" required>
            <div class="invalid-feedback">Pertanyaan ini wajib diisi!</div>
            <div class="valid-feedback">Oke!</div>
            </div>
            </div>
            ...
            <div class="col-sm-4 offset-sm-0">
                <div class="date">
            <input type="date" class="form-control is-invalid" name="tgl_penanaman" required>
            <div class="valid-feedback">Oke!</div>
            </div>
            </div>
</div> 
<div class="form-row">
            ...
            <input type="text"  class="form-control" name="lokasi_tanaman" placeholder="Masukan Lokasi Tanaman" required>
            <div class="invalid-feedback">Pertanyaan ini wajib diisi!</div>
            <div class="valid-feedback">Oke!</div>
            </div>
            </div>
